      ...
      <div className="max-w-2xl mx-auto py-12">
        <Card className="border-green-200 bg-green-50 dark:bg-green-950 dark:border-green-800">
          <CardHeader>
            ...
            <CardDescription>Your prescription has been uploaded successfully</CardDescription>
          </CardHeader>
          <CardContent>
  ...
  return (
    <div className="max-w-2xl mx-auto py-12">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">Upload your prescription documents and medication information</p>
      </div>
        ...
        <Card>
          ...
          <CardContent className="space-y-6">
            ...
            <div className="grid w-full gap-1.5">
              ...
              <Textarea
                id="description"
                placeholder="Brief description of the prescription or medication"
                value={description}
            ...
            <div className="grid w-full gap-1.5">
              ...
              >
                ...
                <p className="text-xs text-muted-foreground">Upload your prescription images</p>
                <Input
                  id="file-upload"
                  type="file"
                  multiple
